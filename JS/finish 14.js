 ...
 */
const myLenhgt = 'Какой-то текст';

console.log(myLenhgt instanceof String);

console.log(typeof myLenhgt);

const myUpLenght = myLenhgt.toUpperCase() ;

console.log(myUpLenght);