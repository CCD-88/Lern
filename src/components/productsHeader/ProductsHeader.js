...
function ProductsHeader() {
  ...
  return (
    <div className="products-header">
      <h1 className="products-header__title">Наша продукция</h1>
      <div className="products-header-basket">
        <span className="products-header-basket__description">
          {count} {nameText(count)} <br />
          на сумму {price} ₽
        </span>
        <Link to="Basket">
          <svg
            className="products-header-basket__img"
            width="50"
            height="50"
            viewBox="0 0 50 50"
            fill="none"
